...
class TurtleController(Node):
    ...
    def move_forward(self, distance, velocity):
        ...
        # Publish the message for the duration of the calculated time
        self.publish_for_duration(twist, time)
    ...
    def publish_for_duration(self, message, duration):
    ...
    def spin_once(self):
        """
        Helper method to wait for messages to be sent.
        """
        while rclpy.ok():
            rclpy.spin_once(self)
            if self.cmd_vel_publisher_.get_subscription_count() > 0:
                break
...
def main(args=None):                                                
    ...
    turtle_controller.move_forward(100, 2)
    print("yo mama's crack")

    # turn 90 degrees to the right
    turtle_controller.turn(3*pi)  # 1.57 radians = 90 degrees
    print("THREE")
    
    # move forward for 1 meter
    turtle_controller.move_forward(20, 4)
    print("FOUR")
    ...
    # move forward for 1 meter
    turtle_controller.move_forward(30, 3)

    # turn 90 degrees to the right
    turtle_controller.turn(1.57)  # 1.57 radians = 90 degrees

    # move forward for 1 meter
    turtle_controller.move_forward(40 ,5)
